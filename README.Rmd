...
The code is based on the specification from [@terasvirta1994specification].

[@terasvirta1994specification] describes the most general model, allowing for
